...
final void runWorker(Worker w) {
        ...
        try {
            ...
            while (task != null || (task = getTask()) != null) {
                ...
                //这个位置判断当前线程池是否状态大于STOP  
                //大于STOP状态且线程未处于中断状态的话需要中断当前线程
                //Thread.interrupted() 判断原来是否调用过中断，并且重置中断标记。这个位置的潜台词是：原来设置过中断，但是代码又走到了这个位置，说明没有中断成功。如果当前线程池是否状态大于STOP  再次中断当前线程。
